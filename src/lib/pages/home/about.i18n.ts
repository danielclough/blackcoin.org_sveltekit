export default {
	...
	users_who_stake: {
		...
		pt: 'Os usuários que mantiverem sua carteira aberta para proteger a rede por meio de "staking" receberão recompensas de 1% a 8% ao ano (varia de acordo com o peso da rede). ' /*Portuguese*/,
	...
	entirely_transparent: {
		...
		pt: 'Todos compartilham o histórico do livro contábil, por isso é totalmente transparente.' /*Portuguese*/,
